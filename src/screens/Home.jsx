    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.imageContainer}>
          <RoundImageContainer size={45} />
        </View>
        <View style={styles.cartContainer}>
          <CartContainer size={45} />
        </View>
        <Banner />
        <View style={styles.imagerow}>
          {imageData.map((item, index) => (
            <View style={styles.roundIconContainer} key={index}>
              <RoundIcon size={45} imageUri={item.uri} />
...
const styles = StyleSheet.create({
  ...
  imageContainer: {
    ...
    right: 57, // Adjust as needed for horizontal spacing
  },
  cartContainer: {
    position: 'absolute', // Position the container absolutely
    top: 31, // Adjust as needed for vertical spacing
    right: 7, // Adjust as needed for horizontal spacing
  },
  imagerow: {
